...
5. copy OrcaSlicer_xx.mo into resources/i18n/xx and rename it to FullSpectrum.mo, then push the changed file.

### Scenario 2. How do I add a new language support

1. Get file FullSpectrum.pot here :
   [https://github.com/softfever/OrcaSlicer/tree/master/localization/i18n](https://github.com/softfever/OrcaSlicer/tree/master/localization/i18n)
...
Notice. When the translation is complete you need to:
    ...
    - copy OrcaSlicer_xx.mo into resources/i18n/xx and rename it to FullSpectrum.mo, then push the changed file.
...
2. Create template file(*.POT) with GNUgettext command:
    ...
    ```shell
    xgettext --keyword=L --add-comments=TRN --from-code=UTF-8 --debug -o FullSpectrum.pot -f list.txt
    ```
...
- To check how the translated text looks on the UI elements, test it :) If you use _PoEdit_, all you need to do is save the file. At this point, a MO file will be created. Rename it FullSpectrum.mo, and you can run OrcaSlicer (see above).
