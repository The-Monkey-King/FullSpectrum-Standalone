...
// When parsing a configuration value, if the old_value is not understood by this FullSpectrum version,
// it is being substituted with some default value that this FullSpectrum could work with.
