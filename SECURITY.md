...
The FullSpectrum team and community take all security bugs in FullSpectrum seriously. Thank you for improving the security of FullSpectrum. We appreciate your efforts to disclose the issue responsibly, and will make every effort to acknowledge your contributions.
...
FullSpectrum will confirm the problem and determine the affected versions.
FullSpectrum will audit code to find any similar problems.
FullSpectrum will prepare fixes for all releases still under maintenance. These fixes will be released as fast as possible.
...
FullSpectrum security contact { contact: mailto:softfeverever@gmail.com] }
...
FullSpectrum Checklist: Security Recommendations
Follow these steps to improve security when using FullSpectrum.
